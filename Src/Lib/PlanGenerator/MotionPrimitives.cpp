...
MotionPrimitive::MotionPrimitive(RobotState q_i, RobotState q_f, WS_Coord pos_f, float cost, RobotPosition_Vector swath, WS_Coord pos_min, WS_Coord pos_max)
{
  	this->q_i = q_i;
  	this->q_f = q_f;
  	this->pos_f = pos_f;
...
WS_Coord MotionPrimitive::get_pos_f()
{
  	return pos_f;
}
...
WS_Coord MotionPrimitive::get_pos_min()
{
  	return pos_min;
}

WS_Coord MotionPrimitive::get_pos_max()
{
  	return pos_max;
}
