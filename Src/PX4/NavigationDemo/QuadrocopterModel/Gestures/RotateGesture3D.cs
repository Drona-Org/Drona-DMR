...
namespace MeshViewer.Gestures
{
    class RotateGesture3D : IMouseGesture
    {
        ...
        double m_XRotation;
        double m_YRotation;
        double m_StartXRotation;
        double m_StartYRotation;
        ...
        {
            Quaternion xRotation = new Quaternion(new Vector3D(0, 1, 0), this.m_XRotation);
            Quaternion yRotation = new Quaternion(new Vector3D(1, 0, 0), this.m_YRotation);
            this.Rotation = xRotation * yRotation;
        ...
        private void OnMouseMove(object sender, System.Windows.Input.MouseEventArgs e)
        {
            if (m_tracking)
            {
                ...
                m_XRotation = m_StartXRotation + (XM_2PI * 2.0f * delta);
                ...
                m_YRotation = m_StartYRotation + (XM_2PI * 2.0f * delta);
        ...
        private void OnMouseLeftButtonDown(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
            ...
            m_StartXRotation = m_XRotation;
            m_StartYRotation = m_YRotation;
