  ...
  PRT_TRANSDECL P_GEND_TRANS_Main_Init[] = 
  {
    
    {
        ...
        P_MACHINE_Main,
        P_EVENT_init,
        P_STATE_Main_Standby,
        _P_FUN_PUSH_OR_IGN,
        0U,
        NULL
    }
  };
  PRT_TRANSDECL P_GEND_TRANS_Main_Standby[] = 
  {
  ...
  PRT_DODECL P_GEND_DOS_Main_Init[] = 
  {
  ...
  PRT_DODECL P_GEND_DOS_Main_Standby[] = 
  {
  ...
  {
    {
      ...
      p_tmp_ret = NULL;
      PrtPopFrame(p_tmp_mach_priv, &p_tmp_frame);
      P_STMT_1(PrtRaise(p_tmp_mach_priv, p_tmp_stmt_0, p_tmp_stmt_1), &P_GEND_VALUE_5, PRT_FALSE, P_EXPR_0(&P_GEND_VALUE_1, PRT_FALSE), PRT_FALSE);
      goto P_EXIT_FUN;
      goto P_EXIT_FUN;
      P_EXIT_FUN:
      PrtFreeLocals(p_tmp_mach_priv, &p_tmp_frame);
  ...
  {
    {
      ...
      p_tmp_ret = NULL;
      PrtPopFrame(p_tmp_mach_priv, &p_tmp_frame);
      P_STMT_1(PrtRaise(p_tmp_mach_priv, p_tmp_stmt_0, p_tmp_stmt_1), &P_GEND_VALUE_5, PRT_FALSE, P_EXPR_0(&P_GEND_VALUE_2, PRT_FALSE), PRT_FALSE);
      goto P_EXIT_FUN;
      goto P_EXIT_FUN;
      P_EXIT_FUN:
      PrtFreeLocals(p_tmp_mach_priv, &p_tmp_frame);
  ...
  {
    {
      ...
      p_tmp_ret = NULL;
      PrtPopFrame(p_tmp_mach_priv, &p_tmp_frame);
      P_STMT_1(PrtRaise(p_tmp_mach_priv, p_tmp_stmt_0, p_tmp_stmt_1), &P_GEND_VALUE_5, PRT_FALSE, P_EXPR_0(&P_GEND_VALUE_3, PRT_FALSE), PRT_FALSE);
      goto P_EXIT_FUN;
      goto P_EXIT_FUN;
      P_EXIT_FUN:
      PrtFreeLocals(p_tmp_mach_priv, &p_tmp_frame);
  ...
  {
    {
      ...
      PrtPopFrame(p_tmp_mach_priv, &p_tmp_frame);
      PrtPrintf("flying...\n");
      P_STMT_1(PrtRaise(p_tmp_mach_priv, p_tmp_stmt_0, p_tmp_stmt_1), &P_GEND_VALUE_5, PRT_FALSE, P_EXPR_0(&P_GEND_VALUE_0, PRT_FALSE), PRT_FALSE);
      goto P_EXIT_FUN;
      goto P_EXIT_FUN;
      P_EXIT_FUN:
      PrtFreeLocals(p_tmp_mach_priv, &p_tmp_frame);
  ...
  PRT_STATEDECL P_GEND_STATES_Main[] = 
  {
    ...
    
    {
        ...
        2,
        P_GEND_EVENTSET_,
        P_GEND_EVENTSET_init,
        P_GEND_EVENTSET_battery_criticalfmom_battery_critical,
        P_GEND_TRANS_Main_Init,
        P_GEND_DOS_Main_Init,
        P_FUN_Main_ANON2,
        P_FUN_Main_ANON0,
        0U,
        NULL
    ...
    
    {
        ...
        1,
        P_GEND_EVENTSET_,
        P_GEND_EVENTSET_take_off,
        P_GEND_EVENTSET_fmom_battery_critical,
        P_GEND_TRANS_Main_Standby,
        P_GEND_DOS_Main_Standby,
        P_FUN_Main_ANON3,
        P_FUN_Main_ANON0,
        0U,
        NULL
