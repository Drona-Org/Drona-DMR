...
_mav_put_uint8_t(buf, 20, (uint8_t)PrtPrimGetInt(PrtTupleGetNC(servo_output_raw, 9)));
...
PrtPrimSetInt(PrtTupleGetNC(*servo_output_raw, 9), _MAV_RETURN_uint8_t(msg, 20));
...
_mav_put_uint32_t(buf, 0, (uint32_t)PrtPrimGetInt(PrtTupleGetNC(attitude_quaternion_cov, 0)));
...
_mav_put_float(buf, 20, (float)PrtGetFloat32(PrtTupleGetNC(attitude_quaternion_cov, 2)));
_mav_put_float(buf, 24, (float)PrtGetFloat32(PrtTupleGetNC(attitude_quaternion_cov, 3)));
_mav_put_float(buf, 28, (float)PrtGetFloat32(PrtTupleGetNC(attitude_quaternion_cov, 4)));
...
_mav_put_float(buf, 32 + count * 4, (float)PrtGetFloat32(PrtSeqGetNCIntIndex(seqVal, count)));
...
PrtPrimSetInt(PrtTupleGetNC(*attitude_quaternion_cov, 0), _MAV_RETURN_uint32_t(msg, 0));
...
PrtSetFloat32(PrtTupleGetNC(*attitude_quaternion_cov, 2), _MAV_RETURN_float(msg, 20));
PrtSetFloat32(PrtTupleGetNC(*attitude_quaternion_cov, 3), _MAV_RETURN_float(msg, 24));
PrtSetFloat32(PrtTupleGetNC(*attitude_quaternion_cov, 4), _MAV_RETURN_float(msg, 28));
...
tmpVal = PrtMkDefaultValue(P_GEND_TYPE_float32);
PrtSetFloat32(tmpVal, _MAV_RETURN_float(msg, 32 + count * 4));
...
PrtSetFloat32(PrtSeqGetNCIntIndex(seqVal, count), _MAV_RETURN_float(msg, 32 + count * 4));
...
_mav_put_uint32_t(buf, 8, (uint32_t)PrtPrimGetInt(PrtTupleGetNC(global_position_int_cov, 1)));
...
_mav_put_int32_t(buf, 24, (int32_t)PrtPrimGetInt(PrtTupleGetNC(global_position_int_cov, 5)));
...
_mav_put_float(buf, 36, (float)PrtGetFloat32(PrtTupleGetNC(global_position_int_cov, 8)));

count = 0;
seqVal = PrtTupleGetNC(global_position_int_cov, 9);
while(count < 36)
{
...
_mav_put_uint8_t(buf, 184, (uint8_t)PrtPrimGetInt(PrtTupleGetNC(global_position_int_cov, 10)));
...
PrtPrimSetInt(PrtTupleGetNC(*global_position_int_cov, 1), _MAV_RETURN_uint32_t(msg, 8));
...
PrtPrimSetInt(PrtTupleGetNC(*global_position_int_cov, 5), _MAV_RETURN_int32_t(msg, 24));
...
PrtSetFloat32(PrtTupleGetNC(*global_position_int_cov, 8), _MAV_RETURN_float(msg, 36));
...
PrtPrimSetInt(PrtTupleGetNC(*global_position_int_cov, 10), _MAV_RETURN_uint8_t(msg, 184));
...
_mav_put_uint32_t(buf, 8, (uint32_t)PrtPrimGetInt(PrtTupleGetNC(local_position_ned_cov, 1)));
...
_mav_put_float(buf, 44, (float)PrtGetFloat32(PrtTupleGetNC(local_position_ned_cov, 10)));

count = 0;
seqVal = PrtTupleGetNC(local_position_ned_cov, 11);
while(count < 45)
{
...
_mav_put_uint8_t(buf, 228, (uint8_t)PrtPrimGetInt(PrtTupleGetNC(local_position_ned_cov, 12)));
...
PrtPrimSetInt(PrtTupleGetNC(*local_position_ned_cov, 1), _MAV_RETURN_uint32_t(msg, 8));
...
PrtSetFloat32(PrtTupleGetNC(*local_position_ned_cov, 10), _MAV_RETURN_float(msg, 44));
...
PrtPrimSetInt(PrtTupleGetNC(*local_position_ned_cov, 12), _MAV_RETURN_uint8_t(msg, 228));
