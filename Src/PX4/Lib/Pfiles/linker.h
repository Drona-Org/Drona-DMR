    ...
    enum P_EVENTS
    {
      ...
      P_EVENT_battery_recharged = 14,
      P_EVENT_battery_status = 15,
      P_EVENT_cmd_local = 16,
      P_EVENT_cmd_retry = 17,
      P_EVENT_command_ack = 18,
      P_EVENT_extended_sys_state = 19,
      P_EVENT_fc_armed = 20,
      P_EVENT_fc_disarmed = 21,
      P_EVENT_fc_emergency_landing = 22,
      P_EVENT_fc_finish_mission_goto = 23,
      P_EVENT_fc_px4_battery_critical = 24,
      P_EVENT_fc_px4_gps_locked = 25,
      P_EVENT_fc_px4_gps_lost = 26,
      P_EVENT_fc_px4_no_heartbeat = 27,
      P_EVENT_fc_ready = 28,
      P_EVENT_geofence_reached = 29,
      P_EVENT_global_position = 30,
      P_EVENT_gps_health_update = 31,
      P_EVENT_gps_raw_int = 32,
      P_EVENT_gps_status = 33,
      P_EVENT_gpshmm_init = 34,
      P_EVENT_heartbeat = 35,
      P_EVENT_heartbeat_monitor_local = 36,
      P_EVENT_heartbeat_status_changed = 37,
      P_EVENT_local_position = 38,
      P_EVENT_mission_arm = 39,
      P_EVENT_mission_disarm = 40,
      P_EVENT_mission_finished = 41,
      P_EVENT_mission_goto = 42,
      P_EVENT_mission_land = 43,
      P_EVENT_mission_loitering = 44,
      P_EVENT_mission_takeoff = 45,
      P_EVENT_porb_local = 46,
      P_EVENT_timer_cancel = 47,
      P_EVENT_timer_cancel_failure = 48,
      P_EVENT_timer_cancel_success = 49,
      P_EVENT_timer_init = 50,
      P_EVENT_timer_start = 51,
      P_EVENT_timer_timeout = 52,
      P_EVENT_vehicle_armed = 53,
      P_EVENT_vehicle_crashed = 54,
      P_EVENT_vehicle_disarmed = 55,
      P_EVENT_vehicle_landed = 56,
      P_EVENT_vehicle_loitering = 57,
      P_EVENT_vehicle_ready = 58,
      _P_EVENTS_COUNT = 59
    };
    ...
    {
      P_GEND_EVENTSET_ = 0,
      P_GEND_EVENTSET_Command = 1,
      P_GEND_EVENTSET_CommandFailedCommandSucceeded = 2,
      P_GEND_EVENTSET_CommandFailedCommandSucceededaltitude_reachedbattery_criticalmission_armmission_disarmmission_goto = 3,
      P_GEND_EVENTSET_CommandFailedCommandSucceededmission_disarmvehicle_crashed = 4,
      P_GEND_EVENTSET_CommandFailedCommandSucceededmission_goto = 5,
      P_GEND_EVENTSET_CommandFailedmission_armmission_gotomission_landmission_takeoff = 6,
      P_GEND_EVENTSET_CommandSucceededfc_px4_battery_criticalfc_px4_gps_lost = 7,
      P_GEND_EVENTSET_POrbPublishPOrbSubscribe = 8,
      P_GEND_EVENTSET_SetGeofenceRadius = 9,
      P_GEND_EVENTSET_SetTargetAltitude = 10,
      P_GEND_EVENTSET_altitude_reachedmission_land = 11,
      P_GEND_EVENTSET_batt_mon_init = 12,
      P_GEND_EVENTSET_battery_criticalbattery_rechargedfc_px4_gps_lockedfc_px4_no_heartbeatglobal_positiongps_health_updateheartbeat_status_changedlocal_positionmission_disarmvehicle_crashed = 13,
      P_GEND_EVENTSET_battery_criticalbattery_rechargedmission_arm = 14,
      P_GEND_EVENTSET_battery_status = 15,
      P_GEND_EVENTSET_cmd_local = 16,
      P_GEND_EVENTSET_command_acktimer_timeout = 17,
      P_GEND_EVENTSET_extended_sys_statelocal_position = 18,
      P_GEND_EVENTSET_fc_emergency_landingfc_px4_battery_criticalfc_px4_gps_lostfc_readygeofence_reached = 19,
      P_GEND_EVENTSET_fc_finish_mission_gotomission_land = 20,
      P_GEND_EVENTSET_global_positiongps_raw_intgps_status = 21,
      P_GEND_EVENTSET_gpshmm_init = 22,
      P_GEND_EVENTSET_heartbeattimer_timeout = 23,
      P_GEND_EVENTSET_heartbeat_monitor_local = 24,
      P_GEND_EVENTSET_local_position = 25,
      P_GEND_EVENTSET_local_positiontimer_cancel_failuretimer_cancel_successtimer_timeout = 26,
      P_GEND_EVENTSET_local_positionvehicle_armedvehicle_crashedvehicle_landed = 27,
      P_GEND_EVENTSET_mission_disarmmission_takeoff = 28,
      P_GEND_EVENTSET_mission_goto = 29,
      P_GEND_EVENTSET_mission_gotomission_land = 30,
      P_GEND_EVENTSET_porb_local = 31,
      P_GEND_EVENTSET_timer_canceltimer_start = 32,
      P_GEND_EVENTSET_timer_cancelnull = 33,
      P_GEND_EVENTSET_timer_cancel_failuretimer_cancel_success = 34,
      P_GEND_EVENTSET_timer_init = 35,
      P_GEND_EVENTSET_timer_start = 36,
      P_GEND_EVENTSET_vehicle_disarmedvehicle_loitering = 37,
      P_GEND_EVENTSET_vehicle_ready = 38,
      _P_EVENTSETS_COUNT = 39
    };
    ...
    extern PRT_MACHINEDECL P_MACHINE_STRUCT_AltitudeMonitorMachine;
    extern PRT_MACHINEDECL P_MACHINE_STRUCT_BatteryMonitorMachine;
    extern PRT_MACHINEDECL P_MACHINE_STRUCT_CommanderMachine;
    extern PRT_MACHINEDECL P_MACHINE_STRUCT_FlightControllerMachine;
    extern PRT_MACHINEDECL P_MACHINE_STRUCT_GPSHealthMonitorMachine;
    extern PRT_MACHINEDECL P_MACHINE_STRUCT_GeofenceMonitorMachine;
    extern PRT_MACHINEDECL P_MACHINE_STRUCT_HeartbeatMonitorMachine;
    extern PRT_MACHINEDECL P_MACHINE_STRUCT_Main;
    extern PRT_MACHINEDECL P_MACHINE_STRUCT_MissionPlannerMachine;
    extern PRT_MACHINEDECL P_MACHINE_STRUCT_POrbMachine;
    extern PRT_MACHINEDECL P_MACHINE_STRUCT_PX4Model;
