    ...
    enum P_FIELD_INDEX_HelperMachinesType
    {
      ...
      P_FIELD_INDEX_HelperMachinesType_commander = 1,
      _P_FIELD_INDEX_HelperMachinesType_COUNT = 2
    };
    ...
    {
      P_FIELD_INDEX_mavlink_attitude_quaternion_cov_t__time_boot_ms = 0,
    ...
    {
      P_FIELD_INDEX_mavlink_global_position_int_cov_t__time_utc = 0,
      P_FIELD_INDEX_mavlink_global_position_int_cov_t__time_boot_ms = 1,
      P_FIELD_INDEX_mavlink_global_position_int_cov_t__lat = 2,
      P_FIELD_INDEX_mavlink_global_position_int_cov_t__lon = 3,
      P_FIELD_INDEX_mavlink_global_position_int_cov_t__alt = 4,
      P_FIELD_INDEX_mavlink_global_position_int_cov_t__relative_alt = 5,
      P_FIELD_INDEX_mavlink_global_position_int_cov_t__vx = 6,
      P_FIELD_INDEX_mavlink_global_position_int_cov_t__vy = 7,
      P_FIELD_INDEX_mavlink_global_position_int_cov_t__vz = 8,
      P_FIELD_INDEX_mavlink_global_position_int_cov_t__covariance = 9,
      P_FIELD_INDEX_mavlink_global_position_int_cov_t__estimator_type = 10,
      _P_FIELD_INDEX_mavlink_global_position_int_cov_t_COUNT = 11
    };
    ...
    {
      P_FIELD_INDEX_mavlink_local_position_ned_cov_t__time_utc = 0,
      P_FIELD_INDEX_mavlink_local_position_ned_cov_t__time_boot_ms = 1,
      P_FIELD_INDEX_mavlink_local_position_ned_cov_t__x = 2,
      P_FIELD_INDEX_mavlink_local_position_ned_cov_t__y = 3,
      P_FIELD_INDEX_mavlink_local_position_ned_cov_t__z = 4,
      P_FIELD_INDEX_mavlink_local_position_ned_cov_t__vx = 5,
      P_FIELD_INDEX_mavlink_local_position_ned_cov_t__vy = 6,
      P_FIELD_INDEX_mavlink_local_position_ned_cov_t__vz = 7,
      P_FIELD_INDEX_mavlink_local_position_ned_cov_t__ax = 8,
      P_FIELD_INDEX_mavlink_local_position_ned_cov_t__ay = 9,
      P_FIELD_INDEX_mavlink_local_position_ned_cov_t__az = 10,
      P_FIELD_INDEX_mavlink_local_position_ned_cov_t__covariance = 11,
      P_FIELD_INDEX_mavlink_local_position_ned_cov_t__estimator_type = 12,
      _P_FIELD_INDEX_mavlink_local_position_ned_cov_t_COUNT = 13
    };
    ...
    enum P_FIELD_INDEX_mavlink_servo_output_raw_t
    {
      ...
      P_FIELD_INDEX_mavlink_servo_output_raw_t__port = 9,
      _P_FIELD_INDEX_mavlink_servo_output_raw_t_COUNT = 10
    };
    ...
    {
      P_FUN_AltitudeMonitorMachine_ANON0 = 39,
      P_FUN_AltitudeMonitorMachine_ANON1 = 40,
      P_FUN_AltitudeMonitorMachine_ANON2 = 41,
      P_FUN_AltitudeMonitorMachine_ANON3 = 42,
      P_FUN_AltitudeMonitorMachine_ANON4 = 43,
      _P_FUNS_AltitudeMonitorMachine_COUNT = 44
    };

    enum P_FUNS_BatteryMonitorMachine
    {
      P_FUN_BatteryMonitorMachine_ANON0 = 39,
      P_FUN_BatteryMonitorMachine_ANON1 = 40,
      P_FUN_BatteryMonitorMachine_ANON2 = 41,
      _P_FUNS_BatteryMonitorMachine_COUNT = 42
    };

    enum P_FUNS_CommanderMachine
    {
      P_FUN_CommanderMachine_ANON0 = 39,
      P_FUN_CommanderMachine_ANON1 = 40,
      P_FUN_CommanderMachine_ANON2 = 41,
      P_FUN_CommanderMachine_ANON3 = 42,
      P_FUN_CommanderMachine_ANON4 = 43,
      P_FUN_CommanderMachine_ANON5 = 44,
      P_FUN_CommanderMachine_ANON6 = 45,
      P_FUN_CommanderMachine_ANON7 = 46,
      P_FUN_CommanderMachine_CancelTimer = 47,
      P_FUN_CommanderMachine_SendCommandToPx4 = 48,
      P_FUN_CommanderMachine_SendWithRetry = 49,
      _P_FUNS_CommanderMachine_COUNT = 50
    };

    enum P_FUNS_FlightControllerMachine
    {
      P_FUN_FlightControllerMachine_ANON0 = 39,
      P_FUN_FlightControllerMachine_ANON1 = 40,
      P_FUN_FlightControllerMachine_ANON2 = 41,
      P_FUN_FlightControllerMachine_ANON3 = 42,
      P_FUN_FlightControllerMachine_ANON4 = 43,
      P_FUN_FlightControllerMachine_ANON5 = 44,
      P_FUN_FlightControllerMachine_ANON6 = 45,
      P_FUN_FlightControllerMachine_ANON7 = 46,
      P_FUN_FlightControllerMachine_ANON8 = 47,
      P_FUN_FlightControllerMachine_ANON9 = 48,
      P_FUN_FlightControllerMachine_ANON10 = 49,
      P_FUN_FlightControllerMachine_ANON11 = 50,
      P_FUN_FlightControllerMachine_ANON12 = 51,
      P_FUN_FlightControllerMachine_ANON13 = 52,
      P_FUN_FlightControllerMachine_ANON14 = 53,
      P_FUN_FlightControllerMachine_ANON15 = 54,
      P_FUN_FlightControllerMachine_ANON16 = 55,
      P_FUN_FlightControllerMachine_ANON17 = 56,
      P_FUN_FlightControllerMachine_ANON18 = 57,
      P_FUN_FlightControllerMachine_ANON19 = 58,
      P_FUN_FlightControllerMachine_ANON20 = 59,
      P_FUN_FlightControllerMachine_ANON21 = 60,
      P_FUN_FlightControllerMachine_ANON22 = 61,
      P_FUN_FlightControllerMachine_ANON23 = 62,
      P_FUN_FlightControllerMachine_ANON24 = 63,
      P_FUN_FlightControllerMachine_ANON25 = 64,
      P_FUN_FlightControllerMachine_ANON26 = 65,
      P_FUN_FlightControllerMachine_ANON27 = 66,
      P_FUN_FlightControllerMachine_ANON28 = 67,
      P_FUN_FlightControllerMachine_ANON29 = 68,
      P_FUN_FlightControllerMachine_ANON30 = 69,
      P_FUN_FlightControllerMachine_ANON31 = 70,
      P_FUN_FlightControllerMachine_ANON32 = 71,
      P_FUN_FlightControllerMachine_ANON33 = 72,
      P_FUN_FlightControllerMachine_ANON34 = 73,
      P_FUN_FlightControllerMachine_ANON35 = 74,
      P_FUN_FlightControllerMachine_ANON36 = 75,
      P_FUN_FlightControllerMachine_ANON37 = 76,
      P_FUN_FlightControllerMachine_ANON38 = 77,
      P_FUN_FlightControllerMachine_CheckHome = 78,
      P_FUN_FlightControllerMachine_CheckReady = 79,
      P_FUN_FlightControllerMachine_FlightControllerReady = 80,
      P_FUN_FlightControllerMachine_InitializeFlightController = 81,
      P_FUN_FlightControllerMachine_IsGPSLocked = 82,
      P_FUN_FlightControllerMachine_IsGlobalPositionKnown = 83,
      P_FUN_FlightControllerMachine_IsHomeSet = 84,
      P_FUN_FlightControllerMachine_IsLocalSet = 85,
      P_FUN_FlightControllerMachine_IsPX4Alive = 86,
      P_FUN_FlightControllerMachine_IsReady = 87,
      _P_FUNS_FlightControllerMachine_COUNT = 88
    };
    ...
    enum P_FUNS_GLOBAL
    {
      ...
      P_FUN_AddFloat32 = 2,
      P_FUN_ArmVehicle = 3,
      P_FUN_AssignFloat32 = 4,
      P_FUN_DisArmVehicle = 5,
      P_FUN_DivFloat32 = 6,
      P_FUN_GetSystemTime = 7,
      P_FUN_GoToLocation = 8,
      P_FUN_IntToFloat32 = 9,
      P_FUN_IsEqFloat32 = 10,
      P_FUN_IsFiniteFloat32 = 11,
      P_FUN_IsGeFloat32 = 12,
      P_FUN_IsGtFloat32 = 13,
      P_FUN_IsInftyFloat32 = 14,
      P_FUN_IsLeFloat32 = 15,
      P_FUN_IsLtFloat32 = 16,
      P_FUN_IsNEqFloat32 = 17,
      P_FUN_IsNaNFloat32 = 18,
      P_FUN_IsNearFloat32 = 19,
      P_FUN_IsNegInftyFloat32 = 20,
      P_FUN_IsPosInftyFloat32 = 21,
      P_FUN_LandVehicle = 22,
      P_FUN_LocalToGlobal = 23,
      P_FUN_MulFloat32 = 24,
      P_FUN_NaNFloat32 = 25,
      P_FUN_NegFloat32 = 26,
      P_FUN_Publish = 27,
      P_FUN_ReturnToLaunch = 28,
      P_FUN_ScientificToFloat32 = 29,
      P_FUN_SendSetHomeCommand = 30,
      P_FUN_SetMessageInterval = 31,
      P_FUN_SubFloat32 = 32,
      P_FUN_Subscribe = 33,
      P_FUN_TakeOff = 34,
      P_FUN_sealwithRR = 35,
      P_FUN_sealwithRTC = 36,
      P_FUN_unsealwithRR = 37,
      P_FUN_unsealwithRTC = 38
    };

    enum P_FUNS_GPSHealthMonitorMachine
    {
      P_FUN_GPSHealthMonitorMachine_ANON0 = 39,
      P_FUN_GPSHealthMonitorMachine_ANON1 = 40,
      P_FUN_GPSHealthMonitorMachine_ANON2 = 41,
      P_FUN_GPSHealthMonitorMachine_ANON3 = 42,
      P_FUN_GPSHealthMonitorMachine_ANON4 = 43,
      _P_FUNS_GPSHealthMonitorMachine_COUNT = 44
    };

    enum P_FUNS_GeofenceMonitorMachine
    {
      P_FUN_GeofenceMonitorMachine_ANON0 = 39,
      P_FUN_GeofenceMonitorMachine_ANON1 = 40,
      P_FUN_GeofenceMonitorMachine_ANON2 = 41,
      P_FUN_GeofenceMonitorMachine_ANON3 = 42,
      _P_FUNS_GeofenceMonitorMachine_COUNT = 43
    };

    enum P_FUNS_HeartbeatMonitorMachine
    {
      P_FUN_HeartbeatMonitorMachine_ANON0 = 39,
      P_FUN_HeartbeatMonitorMachine_ANON1 = 40,
      P_FUN_HeartbeatMonitorMachine_ANON2 = 41,
      P_FUN_HeartbeatMonitorMachine_ANON3 = 42,
      P_FUN_HeartbeatMonitorMachine_ANON4 = 43,
      P_FUN_HeartbeatMonitorMachine_ANON5 = 44,
      P_FUN_HeartbeatMonitorMachine_CancelTimer = 45,
      _P_FUNS_HeartbeatMonitorMachine_COUNT = 46
    };
    ...
    enum P_FUNS_Main
    {
      P_FUN_Main_ANON0 = 39,
      P_FUN_Main_ANON1 = 40,
      _P_FUNS_Main_COUNT = 41
    };

    enum P_FUNS_MissionPlannerMachine
    {
      P_FUN_MissionPlannerMachine_ANON0 = 39,
      P_FUN_MissionPlannerMachine_ANON1 = 40,
      P_FUN_MissionPlannerMachine_ANON2 = 41,
      P_FUN_MissionPlannerMachine_ANON3 = 42,
      P_FUN_MissionPlannerMachine_ANON4 = 43,
      P_FUN_MissionPlannerMachine_ANON5 = 44,
      P_FUN_MissionPlannerMachine_ANON6 = 45,
      P_FUN_MissionPlannerMachine_ANON7 = 46,
      P_FUN_MissionPlannerMachine_ANON8 = 47,
      P_FUN_MissionPlannerMachine_ANON9 = 48,
      P_FUN_MissionPlannerMachine_NextPathSegment = 49,
      _P_FUNS_MissionPlannerMachine_COUNT = 50
    };

    enum P_FUNS_POrbMachine
    {
      P_FUN_POrbMachine_ANON0 = 39,
      P_FUN_POrbMachine_ANON1 = 40,
      P_FUN_POrbMachine_ANON2 = 41,
      P_FUN_POrbMachine_ANON3 = 42,
      P_FUN_POrbMachine_Broadcast = 43,
      P_FUN_POrbMachine_InitializeListener = 44,
      P_FUN_POrbMachine_IsSubscribed = 45,
      _P_FUNS_POrbMachine_COUNT = 46
    };

    enum P_FUNS_PX4Model
    {
      P_FUN_PX4Model_ANON0 = 39,
      _P_FUNS_PX4Model_COUNT = 40
    };

    enum P_MACHINES
    {
      P_MACHINE_AltitudeMonitorMachine = 0,
      P_MACHINE_BatteryMonitorMachine = 1,
      P_MACHINE_CommanderMachine = 2,
      P_MACHINE_FlightControllerMachine = 3,
      P_MACHINE_GPSHealthMonitorMachine = 4,
      P_MACHINE_GeofenceMonitorMachine = 5,
      P_MACHINE_HeartbeatMonitorMachine = 6,
      P_MACHINE_Main = 7,
      P_MACHINE_MissionPlannerMachine = 8,
      P_MACHINE_POrbMachine = 9,
      P_MACHINE_PX4Model = 10,
      _P_MACHINES_COUNT = 11
    };

    enum P_MODELS
    {
      P_MODEL_TimerMachine = 0,
      _P_MODELS_COUNT = 1
    };
    ...
    enum P_STATES_TimerMachine
    {
      _P_STATES_TimerMachine_COUNT = 3
    };
    ...
    {
      P_VAR_BatteryMonitorMachine_commander = 0,
      P_VAR_BatteryMonitorMachine_orb = 1,
      _P_VARS_BatteryMonitorMachine_COUNT = 2
    };
    ...
    enum P_VARS_TimerMachine
    {
      _P_VARS_TimerMachine_COUNT = 1
    };
    ...
    enum mav_protocol_capability
    {
      ...
      _mav_protocol_capability_COUNT = 14,
    ...
    enum mav_sys_status_sensor
    {
      ...
      _mav_sys_status_sensor_COUNT = 25,
    ...
    void P_SEND_TimerMachine_IMPL(PRT_MACHINEINST *sender, PRT_MACHINEINST *context, PRT_VALUE *evnt, PRT_VALUE *payload, PRT_BOOLEAN doTransfer);
