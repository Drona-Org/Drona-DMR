...
DoAction:
	...
	else
	{
		...
		PRT_UINT32 funIndex2 = PrtBottomOfFunStack(context)->funIndex;
		context->process->program->machines[context->instanceOf].funs[funIndex2].implementation((PRT_MACHINEINST *)context);
	}
	goto CheckLastOperation;
