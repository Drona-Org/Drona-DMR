  ...
  static PRT_TYPE P_GEND_TYPE_62 = 
  {
    ...
    {
        (PRT_MAPTYPE *)&P_GEND_TYPE_TUP_62
    }
  };
  ...
  {
    {
      ...
      if (p_tmp_ret == NULL)
      {
        return PrtMkDefaultValue(&P_GEND_TYPE_42);
      }
      else
      {
        return p_tmp_ret;
  ...
  {
    {
      ...
      P_EXPR_5(PrtPushNewFrame(p_tmp_mach_priv, 2U, PRT_FUN_PARAM_CLONE, p_tmp_expr_0, PRT_FUN_PARAM_CLONE, p_tmp_expr_2, PRT_FUN_PARAM_CLONE, p_tmp_expr_4, PRT_FUN_PARAM_CLONE, p_tmp_expr_3), PRT_FALSE, P_TUPLE_1(&P_GEND_TYPE_48, p_tmp_expr_1, p_tmp_expr_3), PRT_TRUE, p_tmp_mach_priv->id, PRT_FALSE, &P_GEND_VALUE_12, PRT_FALSE, p_tmp_mach_priv->varValues[P_VAR_DistributedMotionPlannerMachine_currTaskId], PRT_FALSE, p_tmp_mach_priv->varValues[P_VAR_DistributedMotionPlannerMachine_allRobotsMPV], PRT_FALSE);
      L11:
