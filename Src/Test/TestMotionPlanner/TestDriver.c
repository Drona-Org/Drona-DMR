  ...
  {
    {
      ...
      {
        P_STMT_0(PrtSeqInsertEx(p_tmp_mach_priv->varValues[P_VAR_DistributedMotionPlannerMachine_currentTrajV], PrtTupleGetNC(p_tmp_stmt_0, 0U), PrtTupleGetNC(p_tmp_stmt_0, 1U), PRT_FALSE), P_EXPR_6(P_TUPLE_1(&P_GEND_TYPE_87, p_tmp_expr_0, p_tmp_expr_5), PRT_TRUE, P_TUPLE_1(&P_GEND_TYPE_53, p_tmp_expr_3, p_tmp_expr_4), PRT_TRUE, PrtSeqGetNC(p_tmp_expr_2, p_tmp_expr_0), PRT_FALSE, PrtMkIntValue(PrtPrimGetInt(p_tmp_expr_1) + PrtPrimGetInt(p_tmp_expr_0)), PRT_TRUE, p_tmp_frame.locals[7U], PRT_FALSE, p_tmp_frame.locals[3U], PRT_FALSE, p_tmp_frame.locals[6U], PRT_FALSE), PRT_FALSE);
        PrtFree(PrtTupleGetNC(p_tmp_stmt_0, 0U));
        PrtFree(p_tmp_stmt_0->valueUnion.tuple->values);
        PrtFree(p_tmp_stmt_0->valueUnion.tuple);
        PrtFree(p_tmp_stmt_0);
  ...
  {
    {
      ...
      if (p_tmp_ret == NULL)
      {
        return PrtMkDefaultValue(&P_GEND_TYPE_94);
      }
      else
      {
        return p_tmp_ret;
  ...
  {
    {
      ...
      if (P_BOOL_EXPR(P_EXPR_1(P_SEQ(PrtPushNewFrame(p_tmp_mach_priv, 30U, PRT_FUN_PARAM_CLONE, p_tmp_expr_0), PrtWrapFunStmt(&p_tmp_frame, 0U, p_tmp_mach_priv, 30U)), PRT_TRUE, p_tmp_mach_priv->varValues[P_VAR_DistributedMotionPlannerMachine_receivedTrajFromV], PRT_FALSE), PRT_TRUE))
      {
  ...
  {
    {
      ...
      p_tmp_ret = NULL;
      PrtPopFrame(p_tmp_mach_priv, &p_tmp_frame);
      P_STMT_2(P_SEQ(PrtCheckIsLocalMachineId(context, p_tmp_stmt_0), PrtSend(context, PrtGetMachine(context->process, p_tmp_stmt_0), p_tmp_stmt_1, p_tmp_stmt_2, PRT_FALSE)), P_EXPR_2(P_TUPLE_1(&P_GEND_TYPE_49, p_tmp_expr_0, p_tmp_expr_1), PRT_TRUE, &P_GEND_VALUE_18, PRT_FALSE, &P_GEND_VALUE_15, PRT_FALSE), PRT_TRUE, P_EXPR_0(&P_GEND_VALUE_9, PRT_FALSE), PRT_FALSE, P_EXPR_2(PrtSeqGetNC(p_tmp_expr_0, p_tmp_expr_1), PRT_FALSE, &P_GEND_VALUE_15, PRT_FALSE, p_tmp_mach_priv->varValues[P_VAR_Main_allRobotsV], PRT_FALSE), PRT_FALSE);
      P_STMT_2(P_SEQ(PrtCheckIsLocalMachineId(context, p_tmp_stmt_0), PrtSend(context, PrtGetMachine(context->process, p_tmp_stmt_0), p_tmp_stmt_1, p_tmp_stmt_2, PRT_FALSE)), P_EXPR_2(P_TUPLE_1(&P_GEND_TYPE_49, p_tmp_expr_0, p_tmp_expr_1), PRT_TRUE, &P_GEND_VALUE_19, PRT_FALSE, &P_GEND_VALUE_16, PRT_FALSE), PRT_TRUE, P_EXPR_0(&P_GEND_VALUE_9, PRT_FALSE), PRT_FALSE, P_EXPR_2(PrtSeqGetNC(p_tmp_expr_0, p_tmp_expr_1), PRT_FALSE, &P_GEND_VALUE_16, PRT_FALSE, p_tmp_mach_priv->varValues[P_VAR_Main_allRobotsV], PRT_FALSE), PRT_FALSE);
      goto P_EXIT_FUN;
      P_EXIT_FUN:
      PrtFreeLocals(p_tmp_mach_priv, &p_tmp_frame);
      return p_tmp_ret;
  ...
  PRT_RECEIVEDECL P_GEND_RECEIVE_P_FUN_DistributedMotionPlannerMachine_ANON8[] = 
  {
  ...
  PRT_FUNDECL P_GEND_FUNS_DistributedMotionPlannerMachine[] = 
  {
    ...
    
    {
        ...
        NULL,
        2U,
        P_GEND_RECEIVE_P_FUN_DistributedMotionPlannerMachine_ANON8,
        0U,
        NULL
    },
